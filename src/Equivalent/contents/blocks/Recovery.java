...
public class Recovery extends Block{

    public Recovery(String name){
        super(name);
        hasItems = true;
        update = true;
        solid = true;
        ...
        config(Item.class, (RecoveryBuild tile, Item item) -> tile.outputItem = item);
        configClear((RecoveryBuild tile) -> tile.outputItem = null);
    }
    ...
    public class RecoveryBuild extends Building{
        Item outputItem;
